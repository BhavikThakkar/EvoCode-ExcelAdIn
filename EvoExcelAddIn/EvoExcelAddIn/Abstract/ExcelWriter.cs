...
namespace EvoExcelAddIn
{
    public abstract class ExcelWriter<T>
    {
        ...
        public void WriteDateToExcel(string sheetName, List<T> list, string startColumn, string endColumn)
        {
            this.ActivateExcel(sheetName);
        ...
        /// </summary>
        protected virtual void ActivateExcel(string sheetName)
        {
            ExcelManager.ActivateExcel(sheetName,true);
            _workBook = ExcelManager._workBook;
            _excelSheet = ExcelManager._excelSheet;
        }
